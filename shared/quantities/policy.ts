...
export const QUANTITY_POLICY_VERSION_V4 = 'rectangular-flat-v4' as const;
export type QuantityPolicyVersion = typeof QUANTITY_POLICY_VERSION | typeof QUANTITY_POLICY_VERSION_V2 | typeof QUANTITY_POLICY_VERSION_V3 | typeof QUANTITY_POLICY_VERSION_V4;
...
export const quantityRequestSchema = z.object({
  policy: z.object({
    version: z.enum([QUANTITY_POLICY_VERSION, QUANTITY_POLICY_VERSION_V2, QUANTITY_POLICY_VERSION_V3, QUANTITY_POLICY_VERSION_V4]),
