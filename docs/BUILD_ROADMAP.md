...
Version: 1.13 — M3D building-level ownership and selector verified, 2026-09-08
Repository: `armentrout1/ModernFloorPlanner`; delivery branch: `main`.
Original audit baseline: 876968e78d7070775e7924f33a3164ba20905d42; current application/test commit: 6274e181388b8a74116fd90ecd1ae529780ce17d.
Status: **M3D first slice COMPLETE / PRODUCER_VERIFIED locally; NOT DEPLOYED.** Building-level ownership and selection / #16 are implemented. M3B and M3C / #15 retain completion. Later M3D work remains proposed: linked straight stairs and landings are next, NOT STARTED. Issue #10 remains the release tracker, #2 unreleased, hosting #4 PROPOSED and CRM separate.

Evidence and dated external research: [research and audit](RESEARCH_AND_AUDIT_2026-09-06.md).

## 0. Current building-level checkpoint — 2026-09-08
...
### A8 - Building-layout boundaries (issue #9; first level slice implemented)
...
### M3D - Building layout (first slice COMPLETE; later bounded assignments PROPOSED)

Source: [issue #9 / MFP-BLD-001](https://github.com/armentrout1/ModernFloorPlanner/issues/9). M3B and M3C are complete locally. The owner activated and completed only level ownership and selection in [issue #16](https://github.com/armentrout1/ModernFloorPlanner/issues/16); later assignments require their own bounded activation.
...
2. **NEXT — linked straight stairs/landings (NOT STARTED):** one identity with from/to levels or unresolved destination, measured/proposed geometry and explicit floor/ceiling-void and under-stair policies. L/U variants are later slices. No automatic all-floor footprint subtraction or landing-to-storey conversion.
...
Level acceptance now proves independent same-X/Y projection/hit targets and invariant geometry/totals under names/order/camera changes. Later acceptance still requires: overview movement cannot change quantities; one stair stays consistent from both endpoints; voids affect only explicit surfaces; zones do not double-count; originals, stable IDs, group/opening metadata and historical snapshots remain supported. No structural, egress or code-safety certification is implied.
...
Current state: M1, M2A/B/C, M3A, M3B and M3C remain complete locally. **M3D first slice — building-level ownership and selector — COMPLETE / PRODUCER_VERIFIED locally; NOT DEPLOYED.** Completed Revert #12, manual tabs #13, Undo/Redo #14 and responsive/layout/focus #15 are preserved. Application/test commit 6274e181388b8a74116fd90ecd1ae529780ce17d passes one fresh 437/437 unit and 158/158 browser run, with a separate 1/1 canonical local smoke; [current results](MFP_M3D_LEVELS_RESULTS.md). Next eligible slice: linked straight stairs and landings with explicit destination levels and separate floor/ceiling-opening rules, NOT STARTED. M3D as a whole remains incomplete. #10 stays open for release, #2 unreleased, #4 PROPOSED and CRM separate. Issue #9/A8/M3D/M7 retain the later trade and material boundaries.
