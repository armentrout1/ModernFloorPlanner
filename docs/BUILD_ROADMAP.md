...
Version: 1.3 - M3B entry prerequisite cleared; Slice 1 next, 2026-09-08
...
Track all four slices in issue #10: (1) shared document/room measurements/recovery; (2) physical opening forms; (3) selected work/surfaces and quantity breakdown; (4) supported writable physical-sketch commands and end-to-end acceptance. The selected design is unchanged. Quick Rooms and the legacy editor remain separate today. M3B supplies measured quantities/missing inputs; M7 adds specified recipes/accessories/coverage/waste/purchasing; construction/trade models remain later bounded work.
